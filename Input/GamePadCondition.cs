...
namespace zxc {
    ...
    public class GamePadCondition : ICondition {
        ...
        public bool Down() {
            return Down(_button, _gamePadIndex) && InputHelper.IsActive;
        }
        /// <returns>Returns true when the button was pressed and is now pressed.</returns>
        public bool DownOnly() {
            return DownOnly(_button, _gamePadIndex) && InputHelper.IsActive;
        }
        ...
        /// <returns>Returns true when the button is now pressed.</returns>
        public static bool Down(GamePadButton button, int gamePadIndex) {
            return InputHelper.GamePadButtons[button](InputHelper.NewGamePad, gamePadIndex) == ButtonState.Pressed;
        }
        /// <returns>Returns true when the button was pressed and is now pressed.</returns>
        public static bool DownOnly(GamePadButton button, int gamePadIndex) {
            return InputHelper.GamePadButtons[button](InputHelper.NewGamePad, gamePadIndex) == ButtonState.Pressed &&
